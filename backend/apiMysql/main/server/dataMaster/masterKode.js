...
insert = `INSERT INTO kode_akun (id, kode, uraian, unitId, userId, createAt) 
    VALUES ('`+uniqid()+`' ,'`+req.body.kode+`' ,'`+req.body.uraian+`', '`+req.user.profile.unit_kerja+`' ,'`+req.user._id+`' , NOW() )
    `;
...
var query = `
    DELETE FROM kode_akun WHERE id = '`+req.body.id+`'; 
`;
db.query(query, (err, row)=>{
    if(err){
        res.send(err);
...
insert = `INSERT INTO kode_kelompok (id, akunId, kode, uraian, unitId, userId, createAt) 
    VALUES ('`+uniqid()+`' ,'`+req.body.akunId+`' ,'`+req.body.kode+`' ,'`+req.body.uraian+`' ,'`+req.user.profile.unit_kerja+`' ,'`+req.user._id+`' , NOW() )
    `;
...
var query = `
    DELETE FROM kode_kelompok WHERE id = '`+req.body.id+`'; 
`;
db.query(query, (err, row)=>{
    if(err){
        res.send(err);
...
insert = `INSERT INTO kode_jenis (id, akunId, kelompokId, kode, uraian, unitId, userId, createAt) 
    VALUES ('`+uniqid()+`' ,'`+req.body.akunId+`' ,'`+req.body.kelompokId+`' ,'`+req.body.kode+`' ,'`+req.body.uraian+`' ,'`+req.user.profile.unit_kerja+`' ,'`+req.user._id+`' , NOW() )
    `;
...
var query = `
    DELETE FROM kode_jenis WHERE id = '`+req.body.id+`'; 
`;
db.query(query, (err, row)=>{
    if(err){
        res.send(err);
...
insert = `INSERT INTO kode_objek (id, akunId, kelompokId, jenisId, kode, uraian, unitId, userId, createAt) 
    VALUES ('`+uniqid()+`' ,'`+req.body.akunId+`' ,'`+req.body.kelompokId+`' ,'`+req.body.jenisId+`' ,'`+req.body.kode+`' ,'`+req.body.uraian+`' ,'`+req.user.profile.unit_kerja+`' ,'`+req.user._id+`' , NOW() )
    `;
...
var query = `
    DELETE FROM kode_objek WHERE id = '`+req.body.id+`'; 
`;
db.query(query, (err, row)=>{
    if(err){
        res.send(err);
...
insert = `INSERT INTO kode_rincian (id, akunId, kelompokId, jenisId, objekId, kode, uraian, unitId, userId, createAt) 
    VALUES ('`+uniqid()+`' ,'`+req.body.akunId+`' ,'`+req.body.kelompokId+`' ,'`+req.body.jenisId+`' ,'`+req.body.objekId+`' ,'`+req.body.kode+`' ,'`+req.body.uraian+`' ,'`+req.user.profile.unit_kerja+`' ,'`+req.user._id+`' , NOW() )
    `;
...
var query = `
    DELETE FROM kode_rincian WHERE id = '`+req.body.id+`'; 
`;
db.query(query, (err, row)=>{
    if(err){
        res.send(err);
...
insert = `INSERT INTO kode_sub (id, akunId, kelompokId, jenisId, objekId, rincianId, kode, uraian, unitId, userId, createAt) 
    VALUES ('`+uniqid()+`' ,'`+req.body.akunId+`' ,'`+req.body.kelompokId+`' ,'`+req.body.jenisId+`' ,'`+req.body.objekId+`' ,'`+req.body.kode+`' ,'`+req.body.uraian+`' ,'`+req.user.profile.unit_kerja+`' ,'`+req.user._id+`' , NOW() )
    `;
...
var query = `
    DELETE FROM kode_sub WHERE id = '`+req.body.id+`'; 
`;
db.query(query, (err, row)=>{
    if(err){
        res.send(err);
...
insert = `INSERT INTO kode_sub_sub (id, akunId, kelompokId, jenisId, objekId, rincianId, subId, kode, uraian, unitId, userId, createAt) 
    VALUES ('`+uniqid()+`' ,'`+req.body.akunId+`' ,'`+req.body.kelompokId+`' ,'`+req.body.jenisId+`' ,'`+req.body.objekId+`' ,'`+req.body.rincianId+`' ,'`+req.body.subId+`' ,'`+req.body.kode+`' ,'`+req.body.uraian+`' ,'`+req.user.profile.unit_kerja+`' ,'`+req.user._id+`' , NOW() )
    `;
...
var query = `
    DELETE FROM kode_sub_sub WHERE id = '`+req.body.id+`'; 
`;
db.query(query, (err, row)=>{
    if(err){
        res.send(err);
