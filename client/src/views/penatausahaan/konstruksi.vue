      ...
      <q-card-section class="bg-blue-3 text-white">
        <div class="row">
          <div class="col-12 col-md-6">
            <div class="text-h6 h_titleHead">Konstruki Dalam Pengerjaan</div>
            <div class="text-subtitle2">Kartu Inventaris</div>
          </div>
                  ...
                  <form @submit.prevent="addData()">
                    <q-card-section class="q-pt-none">
                        ...
                        <div class="row">
                          ...
                          <div class="col-12 col-md-12 frame_cari">
                            <span class="h_lable ">Auto Complete with multy label</span>
                            <q-select
                              filled
                              v-model="model"
                              :options="options"
