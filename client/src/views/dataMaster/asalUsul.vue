            ...
            <q-card-section class="bg-blue-3 text-white">
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="text-subtitle2">Asal Usul</div>
                    </div>
            ...
            listData: [
                {
                    "id": 1,
                    "uraian": "Pembelian",
                    "keterangan": "Aset diperoleh melalui proses pembelian resmi menggunakan anggaran"
                },
                {
                    "id": 2,
                    "uraian": "Hibah",
                    "keterangan": "Aset berasal dari pemberian pihak lain tanpa imbalan"
                },
                {
                    "id": 3,
                    "uraian": "Bantuan Pemerintah",
                    "keterangan": "Aset diperoleh dari bantuan pemerintah pusat atau provinsi"
                },
                {
                    "id": 4,
                    "uraian": "Swakelola",
                    "keterangan": "Aset dibangun atau dibuat secara mandiri oleh instansi"
                },
                {
                    "id": 5,
                    "uraian": "Tukar Menukar",
                    "keterangan": "Aset diperoleh melalui proses tukar menukar dengan aset lain"
                },
                {
                    "id": 6,
                    "uraian": "Rampasan",
                    "keterangan": "Aset berasal dari hasil rampasan atau sitaan negara"
                },
                {
                    "id": 7,
