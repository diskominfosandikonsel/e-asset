        ...
        <div class="row">
          ...
          <div class="col-12 col-md-4">
            <div class="row">
              ...
              <q-btn glossy class="bg-red-4" @click="mdl_add = true, form.jenis=1, form.parrent=null" dense flat icon="add" style="width:10%">
          ...
          <!-- =================================================== KONTENT =========================================================== -->
            ...
            <div  v-for="data in list_data" :key="data.id">
                ...
                <tr class="h_table_head bg-blue-2">
                    ...
                    <th width="30%" class="text-center">Nama Menu</th>
