            ...
            <q-card-section class="bg-blue-3 text-white">
                <div class="row">
                    <div class="col-12 col-md-6">
                        ...
                        <div class="text-subtitle2">Sub Rincian Objek</div>
                    </div>
                ...
                <div class="tbl_responsive">
                    ...
                    <table width="100%">
                        <tr class="h_table_head bg-blue-2">
                            ...
                            <th width="15%" colspan="6" class="text-center">Kode</th>
...
export default {
    ...
    methods: {
        ...
        getView: function () {
            ...
            fetch(this.$store.state.url.URL_DM_KODE_AKUN + "sub", {
                method: "POST",
                headers: {
        ...
        addData: function (number) {
            fetch(this.$store.state.url.URL_DM_KODE_AKUN + "addSub", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        editData: function () {
            fetch(this.$store.state.url.URL_DM_KODE_AKUN + "editSub", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        removeData: function (E) {
            fetch(this.$store.state.url.URL_DM_KODE_AKUN + "removeSub", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
