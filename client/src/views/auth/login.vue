         ...
         <div class="col-11 col-md-3 fixed-center">
            <div class="putihTrans formLogin shadow-5">
               ...
               <form @submit.prevent="btn_login()">
                  <q-input v-model="user.username" outlined square :dense="true" class="bg-white"
                  ...
                  <q-btn type="submit" push class="full-width bg-blue-3" icon-right="send" label="LOGIN" style="color:white" />
               </form>
               <br>
               <hr>
