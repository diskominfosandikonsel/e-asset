<template>
    <div>
        <q-card-section class="bg-blue-3 text-white">
            <div class="text-h6 h_modalhead">Pindah Ruang</div>
        </q-card-section>
                ...
                <table width="100%" class="h_table">
                    <thead>
                        <tr class="h_table_head bg-blue-2">
                            ...
                            <th class="text-center" width="25%">Ruang Lama</th>
                            <th class="text-center" width="25%">Ruang Baru</th>
                            <th class="text-center" width="25%">Tanggal Pindah</th>
                    ...
                    <tbody>
                        <tr class="h_table_body" v-for="(data, index) in list_datax" :key="data.id">
                            ...
                            <td>{{ data.ruang_lama }}</td>
                            <td>{{ data.ruang_baru }}</td>
                            <td class="text-center">{{ UMUM.tglConvert(data.tanggal_pindah) }}</td>
                ...
                <q-card-section class="q-pa-md">
                    <div class="row q-col-gutter-sm">
                        <div class="col-12 col-md-12 frame_cari">
                            <span class="h_lable">Ruang Lama</span>
                            <q-input v-model="form.ruang_lama" outlined square dense class="bg-white" />
                        </div>
                        <div class="col-12 col-md-12 frame_cari">
                            <span class="h_lable">Ruang Baru</span>
                            <q-input v-model="form.ruang_baru" outlined square dense class="bg-white" />
                        </div>
                        <div class="col-12 col-md-12 frame_cari">
                            <span class="h_lable ">Tanggal Pindah</span>
                            <q-input v-model="form.tanggal_pindah" type="date" outlined square :dense="true" class="bg-white margin_btn" />
                        </div>
                        <div class="col-12 col-md-12 frame_cari">
            ...
            list_datax: [
                {
                    id: "PR001",
                    aset_id: "BPKB001",
                    ruang_lama: "Garasi Kantor Bupati",
                    ruang_baru: "Garasi Dinas Kominfo",
                    tanggal_pindah: "2023-01-10",
                    keterangan: "Penempatan kendaraan untuk operasional Diskominfo"
                }
            ],
