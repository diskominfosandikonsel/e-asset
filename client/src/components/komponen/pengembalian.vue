<template>
    <div>
        <q-card-section class="bg-red-3 text-white">
            <div class="text-h6 h_modalhead">Pengembalian</div>
        </q-card-section>

        <q-card-section class="q-pt-none">
            <q-btn label="Tambah" icon="add" size="sm" class="bg-red-3 text-white q-mt-md" @click="mdl_add = true" />

            <div class="tbl_responsive q-mt-md">
                <table width="100%" class="h_table">
                    <thead>
                        <tr class="h_table_head bg-red-2">
                ...
                <q-card-section class="q-pa-md">
                    <div class="row q-col-gutter-sm">
                        ...
                        <div class="col-12 col-md-12 frame_cari">
                            ...
                            <q-input v-model="form.pangkat_gol" outlined square dense class="bg-white" disable />
                        </div>
                        <div class="col-12 col-md-6 frame_cari">
                        ...
                        <div class="col-12 col-md-6 frame_cari">
                            ...
                            <q-input v-model="form.opd" outlined square dense class="bg-white" disable />
                        </div>
                        <div class="col-12 col-md-12 frame_cari">
                        ...
                        <div class="col-12 col-md-12 frame_cari">
                            <span class="h_lable">Tanggal Transaksi</span>
                            <q-input v-model="form.transaksi" type="date" outlined square dense class="bg-white" />
                        </div>
                    </div>
                </q-card-section>
...
export default {
    ...
    data() {
        return {
            form: {
                id: '',
                penggunaanId: this.penggunaanId,
                nomor: '',
                tgl: '',
                file: null,
                penerimaId: null,
    ...
    methods: {
        getView: function () {
            ...
            console.log("=================");
            console.log(this.form.penggunaanId);
            console.log("=================");

            this.$store.commit("shoWLoading");
            fetch(this.$store.state.url.URL_PENGEMBALIAN + "view", {
                method: "POST",
                headers: {
                ...
                body: JSON.stringify({
                    ...
                    penggunaanId: this.form.penggunaanId
                })
            })
                .then(res => res.json())
                .then(res_data => {
        ...
        addData: function () {
            ...
            fetch(this.$store.state.url.URL_PENGEMBALIAN + "addData", {
                method: "POST",
                headers: {
                    authorization: "kikensbatara " + localStorage.token
                },
        ...
        editData: function () {
            ...
            fetch(this.$store.state.url.URL_PENGEMBALIAN + "editData", {
                method: "POST",
                headers: {
                    authorization: "kikensbatara " + localStorage.token
                },
        ...
        removeData: function (idnya, file) {
            fetch(this.$store.state.url.URL_PENGEMBALIAN + "removeData", {
                method: "POST",
                headers: {
                    "content-type": "application/json",
                    authorization: "kikensbatara " + localStorage.token
        ...
        selectData: function (data) {
            ...
            this.form.penggunaanId = data.penggunaanId;
            this.form.nomor = data.nomor;
            this.form.tgl = data.tgl;
            this.form.keterangan = data.keterangan;
            this.form.transaksi = data.transaksi;
