                ...
                <table width="100%" class="h_table">
                    <thead>
                        <tr class="h_table_head bg-orange-2">
                            ...
                            <th class="text-center" width="25%">Nilai Lama</th>
                            <th class="text-center" width="25%">Nilai Baru</th>
                    ...
                    <tbody>
                        <tr class="h_table_body" v-for="(data, index) in list_datax" :key="data.id">
                            ...
                            <td class="text-center">{{ UMUM.tglConvert(data.tanggal_koreksi) }}</td>
                            <td>{{ data.alasan }}</td>
...
export default {
            ...
            list_datax: [
                {
                    id: "KR001",
                    aset_id: "BPKB001",
                    field_dikoreksi: "no_polisi",
                    nilai_lama: "DT 1 K",
                    nilai_baru: "DT 10 K",
                    tanggal_koreksi: "2023-06-20",
                    alasan: "Kesalahan input nomor polisi kendaraan"
                }
            ],
    ...
    methods: {
        ...
        selectData: function (data) {
            ...
            this.form.field_dikoreksi = data.field_dikoreksi;
            this.form.nilai_lama = data.nilai_lama;
            this.form.nilai_baru = data.nilai_baru;
            this.form.tanggal_koreksi = data.tanggal_koreksi;
