<template>
   <q-list>
      ...
      <q-item-label class="bg-blue-3 h_titleHead" header><span style="color:white">{{ nama }}</span></q-item-label>
...
export default {
   ...
   methods: {
      ...
      async loadMenu() {
         ...
         var dataMenu = await this.FETCHING.postMasterMenuGetSideBar(profileku.Aset)
